...
if ($this->HAS_ADD_PRIVILEGE==true){
	$lch_ActionsVar = $lch_ActionsVar . '<button type="button" data-loading-text="Loading..." autocomplete="off" class="btn btn-primary btn-sm outer-fields-unique add_interim"><i class="'. $this->BUTTON_ICONS["Add"].'"></i> Add Scheduled Transaction</button>';
				...
				<div class="row">
					...
					<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
						<div class="form-group">
							<label for="" class="col-lg-3 col-md-3 col-sm-3 col-xs-3 control-label">Status</label>
				            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-9">
				        		<select class="form-control input-sm outer-fields-unique-inverted filter-fields"
				        			data-required="0" data-fieldname="Status"

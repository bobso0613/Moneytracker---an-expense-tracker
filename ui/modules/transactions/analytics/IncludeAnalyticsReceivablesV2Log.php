...
$larr_Params = array (
    "fileToOpen" => "transactions/analytics/retrieve_analytics_receivables_log_v2",
...
<div class="panel panel-default">
    <div class="panel-heading">
        <i class="fa fa-list fa-fw"></i> Receivables/Lending as of <?php echo date("F d, Y");?>
    </div>
    <!-- /.panel-heading -->
		...
		?>
			...
			<div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
				...
				?>
					<div class="list-group" style="margin:0px">
						<div class="panel panel-default">
							<div class="panel-heading" role="tab" id="heading_receivables_<?php echo $lin_ctr;?>" style="padding:0px">
								<a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapse_receivables_<?php echo $lin_ctr;?>" aria-expanded="true" aria-controls="collapse_receivables_<?php echo $lin_ctr;?>">
									
										<div class="list-group-item" style="font-size:<?php echo $lch_fontsize;?>">
							                <?php echo $lch_displayname;?>
							                <span class="pull-right " style="font-size:14px"><strong><?php echo number_format($larr_Value["to_receive"],2) ;?></strong>
							                </span>
							            </div>
									
								</a>
							</div>
							<div id="collapse_receivables_<?php echo $lin_ctr;?>" class="panel-collapse collapse" role="tabpanel" aria-labelledby="heading_receivables_<?php echo $lin_ctr;?>">
									...
									<table class="table table-condensed table-small-font table-bordered" style="margin:0px;padding:0px">
										...
										<tbody>
											...
											foreach ($larr_Value["breakdown"] as $lch_InnerKey => $larr_InnerValue) {
												...
												$lin_TotalReceivables += floatval($larr_InnerValue["total_amount_raw"]);
											?>
												<tr>
													<td style="width:7%"><?php echo date_format(date_create($larr_InnerValue["money_trail_date"]),"m/d");?></td>
													<td style="width:68%"><div style="overflow-x:auto;overflow-y:auto;max-height:100px"><?php echo $larr_InnerValue["description"];?></div></td>
			...
			<div class="list-group" style="margin:0px">
				<div class="list-group-item right" style="font-size:24px">
	                <strong>TOTAL</strong>&nbsp;&nbsp;
	                <span class="pull-right " style=""><strong><u><?php echo number_format($lin_TotalReceivables,2) ;?></u></strong>
	                </span>
	            </div>
            </div>

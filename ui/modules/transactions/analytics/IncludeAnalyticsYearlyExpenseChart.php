...
$larr_Params = array (
    "fileToOpen" => "transactions/analytics/retrieve_analytics_yearly_expense_chart",
...
<div class="panel panel-default">
    <div class="panel-heading">
        <i class="fa fa-line-chart fa-fw"></i> Yearly Expense - <strong><?php echo date("Y");?></strong>
    </div>
    <!-- /.panel-heading -->
    <div class="panel-body" id="yearly_expense_body" style="overflow-x:auto;padding:0px;background-color:#fff">
    	<div id="yearly_expense_chart" style="width:800px;height:600px;text-align:center">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
	    ...
	    document.getElementById('yearly_expense_chart').style.width = document.getElementById('yearly_expense_body').offsetWidth + "px";
	    var yearly_expense_chart = echarts.init(document.getElementById('yearly_expense_chart'));

	    var larr_Months = new Array("Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec");

	    // specify chart configuration item and data
	    var yearly_expense_chart_option = {
	        ...
	        toolbox: {
		        feature: {
		            saveAsImage: {title:"Save as Image",name:"Yearly Expense Chart as of <?php echo date("m/d/Y") ;?>"},
	    ...
	    window.addEventListener('resize', function(event){
		  // do stuff here
		  document.getElementById('yearly_expense_chart').style.width = document.getElementById('yearly_expense_body').offsetWidth + "px";
		  yearly_expense_chart.resize();
		});

		// use configuration item and data specified to show chart
		yearly_expense_chart.setOption(yearly_expense_chart_option);

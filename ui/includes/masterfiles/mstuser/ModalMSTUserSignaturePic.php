...
$larr_Params = array (
    ...
    "columns" => "code,user_signature_image_code",
...
<div class="modal fade small-modal" id="upload_signature_modal" tabindex="-1" role="dialog" aria-labelledby="upload_signature_modalLabel" 
        aria-hidden="true" data-backdrop="static" data-keyboard="false">
        <!-- Modal -->
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close cancel_modal_action" title="Cancel and Close this modal" data-modalid="upload_signature_modal" data-trans="custom_action">&times;</button>
                <h3 class="modal-title" id="upload_signature_modalLabel">Upload Signature - <?php echo $_GET["valueviewed"];?> </h3>
            </div>
            <div class="modal-body">
                <form class="form-horizontal" action="" method="post" enctype="multipart/form-data" id="form_upload_signature">
                ...
                ?>
                    ...
                    <div class="form-group">
                         <h4 style="padding-left:40px"><strong>Current Signature:</strong> </h4>
                         <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="text-align:center" id="image-container">
                            <img width="300" height="150" class="image" src="<?php echo ABSOLUTE_PATH."usersignatures.php?thumbmode=false&id=".$larr_OutputUser[0]['user_signature_image_code']."&id2=".$larr_OutputUser[0]['code'] ?>" />
                        </div>


                    </div>
                    <div class="pull-right"><button type="button" disabled class="btn btn-default" id="remove-image2">Remove Signature</button></div>
                    <div class="form-group" >
                    <input type="hidden" id="input_user_code" name="input_user_code" value="<?php echo $larr_OutputUser[0]['code'];?>"/>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="text-align:center" id="image-container">
                            <img width="200" height="200" class="image img-thumbnail img-responsive" id="image-preview" src="<?php echo ABSOLUTE_PATH."resources/assets/nosignature.png";?>" />
                        </div>
                    </div>

                    <div class="form-group" title="Image files only">
                        <label for="user-signature" class="col-lg-4 col-md-4 col-sm-4 col-xs-4 control-label">Select Signature</label>
                        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
                                <input type="file" class="form-control" id="user-signature" name="user-signature" accept="image/gif, image/jpeg, image/jpg, image/png" >
                        </div>
                    </div>
                    ...
                    <script type="text/javascript">
                        function saveCallbackFunction(resp){
                            var fileData = new FormData($('form#form_upload_signature')[0]);
                            $("#loading-message").html("<b>Uploading Signature...</b>");
                            $("#blocker").fadeIn("fast",function(){
                                // save here
                                $.ajax({
                                    url: ABSOLUTE_PATH + "api/masterfiles/SaveMSTUserSignature.php",
                                    type: "post",
                                    cache: false,
                                    contentType: false,
                                    processData: false,
                                    ...
                                    if (isError==true){
                                        ...
                                        $("#upload_signature_save").button("reset");
                                    } // if (isError==true){
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-success btn-sm" id="upload_signature_save" data-loading-text="Saving..." title="Save" data-trans="custom_action" data-modalid="upload_signature_modal"><i class="fa fa-floppy-o"></i> Save</button>
                <button type="button" class="btn btn-default btn-sm cancel_modal_action" title="Cancel and Close this modal" data-modalid="upload_signature_modal" data-trans="custom_action"><i class="fa fa-times"></i> Cancel</button>
            </div>
        </div>
        <!-- /.modal-content -->
    </div>

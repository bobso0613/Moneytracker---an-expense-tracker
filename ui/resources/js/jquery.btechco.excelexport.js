...
(function ($) {
    ...
    $.fn.btechco_excelexport = function (options) {
        ...
        switch ($settings.datatype) {
            ...
            // custom case for galing sa iframe
            case 5:
                Export($("#print-frame").contents().find("#"+$settings.containerid).parent().html());
                // $("#" + $settings.containerid).parent().html()
            break;
        ...
        function Export(htmltable) {
            ...
            // var base64data = window.btoa(excelFile);
            //var base64data = excelFile;

            //console.log(base64data);

            var filename = ($settings.filename == null) ? 'test' :  $settings.filename;
            var uri = 'data:application/vnd.ms-excel;charset=utf-8;' + base64data;
